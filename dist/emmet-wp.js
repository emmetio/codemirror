(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["emmetCodeMirror"] = factory();
	else
		root["emmetCodeMirror"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	function main(cm) {
		var keymap = arguments.length <= 1 || arguments[1] === undefined ? defaultKeymap : arguments[1];
	...
	main.emmet = _emmet2.default;
	main.EmmetEditor = _editor2.default;
	main.setup = function (CodeMirror) {
		// setup default Emmet actions
		_emmet2.default.actions.getList().forEach(function (obj) {
			var action = obj.name;
	...
	function actionDecorator(name) {
		return function (cm) {
			...
			cm.operation(function () {
				return result = runAction(name, new _editor2.default(cm));
			});
			return result;
		};
	}
	...
	function multiSelectionActionDecorator(name) {
		return function (cm) {
			var editor = new _editor2.default(cm);
	...
	function runAction(name, editor) {
		...
		var result = false;
		try {
			result = _emmet2.default.run(name, editor);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmmetEditor = function () {
		function EmmetEditor(ctx) {
			var selIndex = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
	  ...
	  */
	   ...
	   */
			...
			value: function replaceContent(value, start, end, noIndent) {
				...
				// indent new value
				if (!noIndent) {
					value = _emmet2.default.utils.common.padString(value, _emmet2.default.utils.common.getLinePaddingFromPosition(this.getContent(), start));
				}

				// find new caret position
				var tabstopData = _emmet2.default.tabStops.extract(value, { escape: function escape(ch) {
						return ch;
					} });
	   ...
	   */
			...
			value: function normalize(str) {
				...
				if (!ctx.getOption('indentWithTabs')) {
					indent = _emmet2.default.utils.common.repeatString(' ', ctx.getOption('indentUnit'));
				}

				return _emmet2.default.utils.editor.normalize(str, {
					indentation: indent
				});
			}
		}, {
			...
			value: function getSyntax() {
				...
				return syntax || _emmet2.default.utils.action.detectSyntax(this, syntax);
			}
	   ...
	   */
			...
			value: function getProfileName() {
				...
				return _emmet2.default.utils.action.detectProfile(this);
			}
	   ...
	   */
			...
			value: function isValidSyntax() {
				return _emmet2.default.resources.hasSyntax(this.getSyntax());
			}
		}]);
	...
	function posToIndex(cm, pos) {
		if (arguments.length > 2 && (typeof pos === 'undefined' ? 'undefined' : _typeof(pos)) !== 'object') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _emmet = __webpack_require__(3);
	...
	_emmet2.default.preferences.set('css.autoInsertVendorPrefixes', false);
	_emmet2.default.preferences.set('caniuse.enabled', false);

	exports.default = _emmet2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		...
		return {
			...
			resources: resources,
			profile: profile,
			tabStops: __webpack_require__(21),
			htmlMatcher: __webpack_require__(15),
			utils: {
				common: utils,
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		...
		var actionModules = {
			base64: __webpack_require__(7),
			editPoints: __webpack_require__(58),
			evaluateMath: __webpack_require__(59),
			expandAbbreviation: __webpack_require__(61),
			incrementDecrement: __webpack_require__(64),
			lineBreaks: __webpack_require__(65),
			balance: __webpack_require__(66),
			mergeLines: __webpack_require__(67),
			reflectCSSValue: __webpack_require__(68),
			removeTag: __webpack_require__(69),
			selectItem: __webpack_require__(70),
			selectLine: __webpack_require__(71),
			splitJoinTag: __webpack_require__(72),
			toggleComment: __webpack_require__(73),
			updateImageSize: __webpack_require__(74),
			wrapWithAbbreviation: __webpack_require__(75),
			updateTag: __webpack_require__(76)
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		...
		var actionUtils = __webpack_require__(10);
		var editorUtils = __webpack_require__(57);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		var utils = __webpack_require__(4);
		var cssSections = __webpack_require__(11);
		var abbreviationParser = __webpack_require__(20);
		var htmlMatcher = __webpack_require__(15);
		var xmlEditTree = __webpack_require__(16);
		var range = __webpack_require__(5);
		var resources = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		var utils = __webpack_require__(4);
		var commentsUtils = __webpack_require__(12);
		var range = __webpack_require__(5);
		var stringStream = __webpack_require__(13);
		var cssParser = __webpack_require__(14);
		var htmlMatcher = __webpack_require__(15);
		var xmlEditTree = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		var editTree = __webpack_require__(17);
		var xmlParser = __webpack_require__(19);
		var range = __webpack_require__(5);
		var utils = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		var range = __webpack_require__(5);
		var utils = __webpack_require__(4);
		var klass = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		var tabStops = __webpack_require__(21);
		var profile = __webpack_require__(34);
		var filters = __webpack_require__(35);
		var utils = __webpack_require__(4);
		var abbreviationUtils = __webpack_require__(37);
		var stringStream = __webpack_require__(13);

		// pre- and post-processorcs
		var lorem = __webpack_require__(51);
		var procPastedContent = __webpack_require__(52);
		var procTagName = __webpack_require__(53);
		var procResourceMatcher = __webpack_require__(54);
		var procAttributes = __webpack_require__(55);
		var procHref = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		var handlerList = __webpack_require__(23);
		var utils = __webpack_require__(4);
		var elements = __webpack_require__(24);
		var logger = __webpack_require__(26);
		var stringScore = __webpack_require__(27);
		var cssResolver = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		var prefs = __webpack_require__(29);
		var resources = __webpack_require__(22);
		var stringStream = __webpack_require__(13);
		var ciu = __webpack_require__(30);
		var utils = __webpack_require__(4);
		var template = __webpack_require__(31);
		var cssEditTree = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		...
		var range = __webpack_require__(5);
		var stringStream = __webpack_require__(13);
		var tokenIterator = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		...
		var registeredFilters = {
			...
			haml: __webpack_require__(40),
			jade: __webpack_require__(41),
			jsx: __webpack_require__(42),
			slim: __webpack_require__(43),
			xsl: __webpack_require__(44),
			css: __webpack_require__(45),
			bem: __webpack_require__(46),
			c: __webpack_require__(47),
			e: __webpack_require__(48),
			s: __webpack_require__(49),
			t: __webpack_require__(50)
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		var abbrUtils = __webpack_require__(37);
		var utils = __webpack_require__(4);
		var tabStops = __webpack_require__(21);
		var formatFilter = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		...
		var tabStops = __webpack_require__(21);
		var utils = __webpack_require__(4);
		var tagName = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		var htmlFilter = __webpack_require__(36);
		var prefs = __webpack_require__(29);
		var abbreviationUtils = __webpack_require__(37);
		var utils = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		...
		var template = __webpack_require__(31);
		var abbrUtils = __webpack_require__(37);
		var filterCore = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		...
		var editorUtils = __webpack_require__(57);
		var actionUtils = __webpack_require__(10);
		var cssGradient = __webpack_require__(62);
		var parser = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		...
		var cssEditTree = __webpack_require__(32);
		var editorUtils = __webpack_require__(57);
		var linearGradient = __webpack_require__(63);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
		var utils = __webpack_require__(4);
		var resources = __webpack_require__(22);
		var matcher = __webpack_require__(15);
		var editorUtils = __webpack_require__(57);
		var profile = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var res = __webpack_require__(22);
	var snippets = __webpack_require__(78);
